...
const enableWechatCorpTpAuthSQL = `
...
const disableWechatCorpTpAuthSQL = `
replace into wechat_corp_third_platform_authorizer
      (code_name
      ,suite_id
      ,corp_id
...
const queryWechatCorpTpPermanentCodeSQL = `
...
const createWechatCorpTpAuthTokenSQL = `
...
const updateWechatCorpTpAuthTokenSQL = `
...
const queryWechatCorpTpAuthTokenSQL = `
